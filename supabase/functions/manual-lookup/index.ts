...
const TRANSLATIONS: Record<string, string> = {
  ...
  'vzduchový filtr': 'air filter', 'vzduchový filtr motoru': 'air filter',
  'snímač maf': 'MAF sensor', 'maf senzor': 'MAF sensor', 'snímač hmotnostního průtoku': 'MAF sensor',
  'snímač map': 'MAP sensor', 'map senzor': 'MAP sensor', 'snímač tlaku sání': 'MAP sensor',
  'sacím potrubí': 'intake manifold', 'sací potrubí': 'intake manifold',
  'snímač nox': 'NOx sensor', 'měrný článek nox': 'NOx sensor',
  'adblue čerpadlo': 'AdBlue pump', 'dávkovací ventil adblue': 'AdBlue dosing valve',
  'scr katalyzátor': 'SCR catalyst', 'dpf filtr': 'DPF filter', 'filtr pevných částic': 'DPF filter',
  'snímač teploty výfuku': 'exhaust temperature sensor',
  'škrtící klapka': 'throttle body', 'škrtici klapka': 'throttle body',
  'vysokotlaké čerpadlo': 'high-pressure fuel pump', 'vstřikovací čerpadlo': 'injection pump',
  'snímač polohy klikového hřídele': 'crankshaft position sensor',
  'snímač polohy vačkového hřídele': 'camshaft position sensor',
  'snímač teploty chladiva': 'coolant temperature sensor',
  'snímač tlaku turba': 'boost pressure sensor', 'snímač plnícího tlaku': 'boost pressure sensor',
  // German
  luftfilter: 'air filter', 'maf sensor': 'MAF sensor', 'map sensor': 'MAP sensor',
  saugrohr: 'intake manifold', drosselklappe: 'throttle body',
...
const COMPONENT_RG: Record<string, string[]> = {
  ...
  'boost pressure sensor': ['21'], 'turbocharger boost': ['21'],
  ...
  'fuel filter': ['20'], 'fuel pump': ['20'], 'high-pressure fuel pump': ['20'], 'injection pump': ['20'],
  injector: ['23'], injection: ['23'],
  exhaust: ['26'], 'catalytic converter': ['26'], 'EGR valve': ['26'],
  'NOx sensor': ['26'], 'SCR catalyst': ['26'], 'AdBlue pump': ['26'], 'AdBlue dosing valve': ['26'],
  'DPF filter': ['26'], 'exhaust temperature sensor': ['26'],
  'glow plug': ['28'], 'spark plug': ['15'],
  clutch: ['30'],
  'air filter': ['24'], 'MAF sensor': ['24'], 'MAP sensor': ['24'],
  'intake manifold': ['24'], 'throttle body': ['24'],
  'crankshaft position sensor': ['13'], 'camshaft position sensor': ['15'],
