...
export const strings = {
  ...
  // Známé závady tohoto vozu (panel na novém případu)
  'known.title':          'ZNÁMÉ ZÁVADY TOHOTO VOZU',
  'known.subtitle':       'Potvrzené opravy z databáze pro vybrané vozidlo',
  'known.loading':        'Načítám známé závady…',
  'known.loadingCases':   'Načítám případy…',
  'known.lowData':        'V databázi zatím {count} případů pro tento vůz — na statistiku je to málo',
  'known.showAllGens':    'Zobrazit všechny generace ({count} případů)',
  'known.allGensNote':    'Zobrazeny všechny generace modelu dohromady',
  'known.exactGensOnly':  'jen vybraná generace',
  'known.genUnknown':     '+ {count} případů bez určené generace',
  'known.unclassified':   '+ {count} případů bez zařazené závady',
  'known.bandLabel':      'NÁJEZD:',
  'known.bandAll':        'vše',
  'known.band0':          'do 100 tis.',
  'known.band100':        '100–150 tis.',
  'known.band150':        '150–200 tis.',
  'known.band200':        'nad 200 tis.',
  'known.noFaultsForBand': 'Pro toto pásmo nájezdu nejsou v databázi žádné případy.',
  'known.allUnclassified': 'Případy v databázi existují, ale zatím nejsou roztříděné podle závady.',
  'known.casesHeader':    'POTVRZENÉ OPRAVY',
  'known.mileageUnknown': 'nájezd neuveden',
  'known.sourceUser':     'uživatel DriveCodex',
  'known.prefillBtn':     'Předvyplnit hypotézu do diagnostiky',
  'known.hypothesis':     'Podezření dle databáze: {fault} ({count} potvrzených případů pro {model})',
  ...
  'guide.phaseTests':         'OVĚŘENÍ PŘÍČINY',
  'guide.phaseActions':       'MOŽNÉ OPRAVY — VYBERTE, CO PROVEDETE',
  'guide.phaseFinal':         'ZÁVĚREČNÁ KONTROLA',
  'guide.partsHint':          'Může být potřeba: {parts} — neobjednávejte předem, dokud nevíte, co budete měnit.',
  'guide.stepDone':           'Krok dokončen',
  'guide.stepSkip':           'Přeskočit',
  'guide.skipped':            'přeskočeno',
  'guide.undo':               'Vrátit',
  'guide.choose':             'Provedu tuto opravu',
  'guide.didItHelp':          'Po provedení: odstranila tato oprava závadu?',
  'guide.helpedBtn':          'Pomohlo',
  'guide.failedBtn':          'Nepomohlo',
  'guide.failedLabel':        'nepomohlo',
  'guide.notNeeded':          'nebylo potřeba',
  'guide.checkValues':        'Utahovací momenty a náplně ověřte v dílenské příručce — AI je negeneruje.',
  'guide.allFailed':          'Žádná z navržených oprav nepomohla.',
  'guide.persistsBtn':        'Závada přetrvává',
  'guide.stepVerifyDefault':  'Zkušební jízda a kontrola chybových kódů',
  'guide.finalSolvedBtn':     'Vyřešeno',
  ...
  'guide.persistsTitle':      'Závada přetrvává',
  'guide.persistsHint':       'Pokus se uloží k případu — nic se nemaže. Vraťte se k diagnóze a zkuste další pravděpodobnou závadu, případně doplňte nové informace a spusťte diagnostiku znovu.',
  'guide.endAttempt':         'Ukončit pokus',
  'guide.endTitle':           'Ukončit pokus?',
  'guide.endMessage':         'Pokus „{fault}" se uloží do historie případu. Zpět už ho vrátit nepůjde — další práce na této závadě začne novým pokusem.',
  'guide.attemptsTitle':      'PŘEDCHOZÍ POKUSY',
  'guide.attemptSolved':      '{fault} — vyřešeno: {action}',
  'guide.attemptFailed':      '{fault} — nepomohlo: {actions}',
  'guide.attemptNone':        '{fault} — bez dokončené opravy',
  'guide.valuesNote':         'Utahovací momenty a plnicí množství AI negeneruje — ověřte je v dílenské příručce.',
  'guide.replaceTitle':       'Začít jinou opravu?',
  'guide.replaceMessage':     'Rozpracovaný pokus „{fault}" se uloží do historie případu a začne se nová oprava.',
  'guide.replaceConfirm':     'Začít novou opravu',
