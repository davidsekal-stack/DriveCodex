...
export const strings = {
  ...
  // Known faults for this vehicle (new-case panel)
  'known.title':          'KNOWN FAULTS FOR THIS VEHICLE',
  'known.subtitle':       'Confirmed fixes from the database for the selected vehicle',
  'known.loading':        'Loading known faults…',
  'known.loadingCases':   'Loading cases…',
  'known.lowData':        'Only {count} cases in the database for this vehicle — too few for statistics',
  'known.showAllGens':    'Show all generations ({count} cases)',
  'known.allGensNote':    'Showing all generations of this model combined',
  'known.exactGensOnly':  'selected generation only',
  'known.genUnknown':     '+ {count} cases without a determined generation',
  'known.unclassified':   '+ {count} cases without a classified fault',
  'known.bandLabel':      'MILEAGE:',
  'known.bandAll':        'all',
  'known.band0':          'under 100k',
  'known.band100':        '100–150k',
  'known.band150':        '150–200k',
  'known.band200':        'over 200k',
  'known.noFaultsForBand': 'No cases in the database for this mileage band.',
  'known.allUnclassified': 'Cases exist in the database but are not yet categorised by fault.',
  'known.casesHeader':    'CONFIRMED FIXES',
  'known.mileageUnknown': 'mileage not stated',
  'known.sourceUser':     'DriveCodex user',
  'known.prefillBtn':     'Prefill hypothesis into diagnosis',
  'known.hypothesis':     'Database-based suspicion: {fault} ({count} confirmed cases for {model})',
  ...
  'guide.endTitle':           'End this attempt?',
  'guide.endMessage':         'The attempt "{fault}" will be saved to the case history. It cannot be reopened — further work on this fault starts a new attempt.',
  'guide.attemptsTitle':      'PREVIOUS ATTEMPTS',
  'guide.attemptSolved':      '{fault} — resolved: {action}',
